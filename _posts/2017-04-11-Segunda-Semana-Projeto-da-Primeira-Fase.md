...
[Mapa do labirinto apenas com as paredes. A entrada está na parte superior.]({{ site.url }}/assets/labirinto-jogo.jpg)
...
[Mapa do labirinto com os caminhos da entrada aos números, além das posições dos números e outros objetos de interesse que pensamos]({{ site.url }}/assets/labirinto-jogo-v1.jpg)
